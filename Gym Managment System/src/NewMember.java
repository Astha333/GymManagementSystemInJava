...
public class NewMember extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jComboBox2.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "05:00 AM - 11:00 AM", "04:00 PM - 09:30 AM" }));
    ...
    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
        ...
        String aadharnmber=jTextField6.getText();
        String age=jTextField7.getText();
        String amount=jTextField8.getText();
        try
        {
            Connection con=ConnectionProvider.getCon();
            PreparedStatement ps=con.prepareStatement("insert into member");
        }
        catch(Exception e)
                {}
